<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2  space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div class="text-medium pt-2  md:pt-0 md:pe-2 hover:text-blue-700">
                <a href="/login"><i class="fa-solid fa-user "></i><span class="hidden md:inline"> Masuk</span></a>
            </div>
            <div class="text-medium pt-2  md:pt-0 md:pe-2 hover:text-blue-700">
                <a href=""><i class="fa-solid fa-heart"></i><span class="hidden md:inline"> Favorit</span></a>
            </div>
            <div class="text-medium pt-2  md:pt-0 hover:text-blue-700">
                <a href=""><i class="fa-solid fa-cart-shopping "></i><span class="hidden md:inline"> Tas
                        Belanja</span></a>
            </div>
