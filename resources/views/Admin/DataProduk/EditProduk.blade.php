...
@section('content')
    ...
    <div>
        <form class="max-w-lg mx-auto" method="POST" action="{{ route('admin.updateProduk', $produk->id) }}"
            ...
            <div class="mb-5">
                ...
                <input type="text" id="kd_produk" name="kd_produk" value="{{ $produk->kd_produk }}"
            ...
            <div class="row flex  gap-2">
                ...
                <div class="col-lg-6 w-full">
                    <div class="mb-5">
                        ...
                        <input type="text" id="stok" name="stok" value="{{ $produk->stok }}"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                        @error('stok')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="mb-5">
                ...
                <input type="text" id="lokasi" name="lokasi" value="{{ $produk->lokasi }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                @error('lokasi')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input type="text" id="ukuran" name="ukuran" value="{{ $produk->ukuran }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                @error('ukuran')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <div>
                    <img class="pb-3" src="{{ asset('gambar/' . $produk->gambar) }}" alt="">
                ...
                <div class="mb-5">
                    ...
                    <select id="kategori_id" name="kategori_id" value="{{ $produk->kategori_id }}"
                ...
                <div>
                    ...
                    <input id="message" rows="4" name="deskripsi"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Leave a comment..." value="{{ $produk->deskripsi }}"></input>
                    @error('deskripsi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="pt-4">
                    <button type="submit"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">Edit
                        Produk</button>
                </div>
        </form>
    </div>
