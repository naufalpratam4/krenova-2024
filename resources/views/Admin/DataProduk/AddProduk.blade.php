...
@section('content')
    <div class="text-4xl font-bold pt-8 pb-5">Tambah Produk</div>
    @if (session('success'))
    ...
    <div>
        <form class="max-w-lg mx-auto" method="POST" action="{{ route('admin.addProduk') }}" onsubmit="return validateForm()">
            @csrf
            <div class="mb-5">
