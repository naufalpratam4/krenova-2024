@extends('layouts.UserAfterLogin.MasterLandingPage')
...
@section('content')
    ...
    <div class="fixed bottom-0 right-0 m-5">
        <button class="btn bg-green-400 rounded-lg py-4 px-6 font-bold hover:bg-green-700 hover:text-white text-lg"
            style="transition: .3s">
            <i class="fa-solid fa-robot"></i>Tanya Bot
        </button>
    </div>
@endsection
